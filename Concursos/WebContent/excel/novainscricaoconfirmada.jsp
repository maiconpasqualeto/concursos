...
<head>
	...
	function popup(nome,w,h,scroll){
		var cpf = $("#cpf").val();
		pagina = 'excelinscricao.do?acao=ImprimirBoleto&cpf=' + cpf;
				...
				<table width="100%" border="1px" cellpadding="0" cellspacing="0" border="0">
					...
					<TR>
						<TD>
							...
							<html:hidden styleId="cpf" property="cpf" name="excelInscricaoForm" />
						</TD>
						<TD>
					...
					<TR>
						<td>
							<input type="button" value="Imprimir" name="btnimprimir"
								onclick="CallPrint('excelinscricao.do?acao=Imprimir&inscricao=');" />
