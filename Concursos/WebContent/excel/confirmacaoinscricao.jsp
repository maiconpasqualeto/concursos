		...
		<tr>
			...
			<td width="650px">
				<table width="100%" border="1px" cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td colspan="4"><b>
							<span style="color: red;">
								Confirma sua inscrição para o concurso 01/2009 com base no Decreto Municipal nº 5.420 de 26 de março de 2009?<br>
					...
					<TR>
						<TD  colspan="3">
							...
							<html:hidden styleId="nome" property="nome" />
						</TD>
						<TD>
							<label>Sexo</label> 
				...
				<table>
					<TR>
						<td>
							<html:submit value="Confirma" property="acao" />
							<html:submit value="Nova Inscricao" property="acao" />
